namespace LibraryPhysicalUnits8may2024.Test
{
    public class UnitTestLength8may2024
    {
        ...
        public void Test63()
        {
            ...
            Assert.Equal(expected: 123, actual: height_1.GetInMeter(), tolerance: 1);

            var height_2 = -a * time_ball_2.Square() / 2.0;
            Console.WriteLine("height_2 = " + height_2); // 44.14 m
            Assert.Equal(expected: 44, actual: height_2.GetInMeter(), tolerance: 1);

            var height_difference = height_1 - height_2;
            Console.WriteLine("height_difference = " + height_difference); // 78.48 m
            Assert.Equal(expected: 78, actual: height_difference.GetInMeter(), tolerance: 1);
        ...
        public void Test64()
        {
            ...
            Assert.Equal(expected: 45, actual: distance.GetInMeter(), tolerance: 1);
